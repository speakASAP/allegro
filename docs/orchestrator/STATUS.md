...
- [PROVEN: synthetic provider status `ISSUE` updates Warehouse to `not_delivered` and Orders lifecycle to `not_received` in detail, customer, and admin read models.]
