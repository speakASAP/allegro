...
| Machine identity | Auth-issued pair RS256 Bearer per [`SERVICE_IDENTITY_CONSUMER_STANDARD.md`](../auth-microservice/docs/SERVICE_IDENTITY_CONSUMER_STANDARD.md) |
| Human JWT verify | [`CONSUMER_JWT_VALIDATION_STANDARD.md`](../auth-microservice/docs/CONSUMER_JWT_VALIDATION_STANDARD.md) (RS256 / JWKS — never shared `JWT_SECRET` HMAC) |
